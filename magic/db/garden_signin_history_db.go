...
type GardenSigninHistory struct {
	...
	HGardenID int    `json:"h_garden_id" form:"h_garden_id" gorm:"column:h_garden_id;comment:'花园id'"`
	HUserID   int    `json:"h_user_id" form:"h_user_id" gorm:"column:h_user_id;comment:'用户id'"`
